...
export const AboutCarrouselSlide = ({ slide, reverse }: Props) => {
  return (
    <div className="flex flex-col mb-20 max-w-91 mx-auto pb-4 lg:flex-row-reverse lg:max-w-[1424px] lg:justify-center lg:mb-7">
      ...
      <div className={cn('mt-10 mb-5 flex flex-col justify-between items-start relative lg:bg-white lg:rounded-l-md lg:my-0 lg:w-full lg:pl-26 lg:py-26', reverse && 'flex-col-reverse')}>
        <img
          src={slide.icon}
          alt="*"
          className="relative -top-3.5 lg:w-21 hidden lg:block"
        />
        <article>
